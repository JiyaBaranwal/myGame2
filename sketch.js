...
function preload(){
  thief = loadAnimation("2thief.png, 2thief1.png, 2thief2.png");
  police = loadImage ("police.jpg");
  coin = loadImage ("coin-gif.gif");
  ...
  obstacle2 = loadImage("obstacle1.webp");
...
function setup() {
 ...
 console.log(message)
  ...
  thief1 = createSprite(50,160,20,50);
  thief1.addAnimation("running", thief);
  //thief.addAnimation("collided", trex_collided);
